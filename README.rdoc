    ...
    module Bio
	  module KB
	    class DummyMySpecialDB < ActiveRecord::Base
	      ...
	      establish_connection(:adapter =>'sqlite3',:database =>"#{File.dirname(__FILE__)}/../../../db/mirbase.sqlite3")
	    end
	  end
	end

The model must be located in a directory structure like lib/bio/kb/mirbase this is important because ActiveRecord can map the namespace with the directory tree.
