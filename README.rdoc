...
* Ruby: Ruby: 1.9, development and installation have been tested on 1.9.2, 1.9.3. Note: Rubygems will not let you install Biogem in an environment with a Ruby interpreter older than 1.9.X
