...
* gem install bio-geek (not yet published on rubygems, grab it from github http://github.com/helios/bioruby-gem and build the gem (gem build bioruby-gem.gemspec; gem install bioruby-gem.gem))
* $ biogem mystuff
